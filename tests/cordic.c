#define FFT_WRITE_LANE_1 0x2000
#define FFT_WRITE_LANE_2 0x2008
#define FFT_WRITE_LANE_3 0x2010
#define FFT_WRITE_LANE_4 0x2018

#define FFT_READ_LANE_1 0x2100
#define FFT_READ_LANE_2 0x2108
#define FFT_READ_LANE_3 0x2110
